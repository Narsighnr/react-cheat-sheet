  ...
  return (
    <div className='h-max flex flex-col gap-6  bg-sky-950 p-4 text-white'>
      <div className='   '>
        ...
        <p className='text-base md:text-xl lg:text-xl mt-4 leading-10 font-light'>
        ...
        <p className=' text-orange-400 text-base font-light md:text-xl lg:text-xl'>
        ...
        <div className=' bg-gray-950 lg:w-1/3 md:w-2/3 w-full p-4'>
          ...
          <small className='block underline italic mt-3'>see more? open the console</small>
        </div>
    </div>
  )
}
