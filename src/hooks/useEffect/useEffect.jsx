  ...
  return (
    <div className=' bg-sky-950 leading-10 p-6  w-full flex flex-col gap-8'>
        ...
        <div className='w-full flex flex-col'>
            <p className='text-white font-normal text-base md:text-xl lg:text-lg m-2'>Without dependencies:</p>
            <pre className='w-full text-wrap bg-gray-950 text-yellow-300 text-sm md:text-base lg:text-lg '>
                 <code>
                    {codeSnippetNoneDeps}
                </code>
            </pre>
            <p className='text-white font-normal text-base md:text-xl lg:text-lg m-2'>With dependencies:</p>
